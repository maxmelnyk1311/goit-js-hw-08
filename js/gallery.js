...
galleryClick.addEventListener("click", onGalleryItemClick);
function onGalleryItemClick(event) {
  ...
  const { original, description } = images.find(image => image.original === imgSource);
  myModal = basicLightbox.create(`<img class="modal-image" src="${original}" alt="${description}">`,
    {
